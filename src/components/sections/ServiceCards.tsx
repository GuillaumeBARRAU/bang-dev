    ...
    <section className="bg-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <p className="mt-2 text-neutral-600">
          Deux services clairs, une approche simple et efficace.
        </p>

        <div className="mt-8 grid gap-4 md:grid-cols-2">
          <div className="rounded-3xl border p-6 bg-neutral-50">
            <h3 className="text-lg font-semibold">Sites internet</h3>
          ...
          <div className="rounded-3xl border p-6 bg-neutral-50">
            <h3 className="text-lg font-semibold">Aide informatique seniors</h3>
            <ul className="mt-3 space-y-2 text-sm text-neutral-700">
              <li>• PC/Mac, imprimantes, Internet</li>
